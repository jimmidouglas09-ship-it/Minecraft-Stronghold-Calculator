...
unique_ptr<Bitmap> CoordinateReader::BitmapFromHWND(HWND hwnd) {
...
int CoordinateReader::GetShownCoordinates(HWND hwnd, Vec3* coordinates) {
...
void CoordinateReader::findMinecraftWindow() {
